        ...
        <div className="row align-items-center">
          <div className="col-xl-7 col-lg-6">
            <div className="image_box wow fadeInLeft">
              {/* <img src="assets/images/about/image_1.jpg" alt="img" className="image-fit image_1 rounded-circle"> */}
              {/* <img src="assets/images/about/image_2.jpg" alt="img" className="image-fit image_2 rounded-circle"> */}
            </div>
          </div>
